...
const u8 gText_NextFusionMon[] = _("Choose MOé to fuse with.");
...
const u8 gText_DoWhatWithPokemon[] = _("Do what with this MOé?");
...
const u8 gText_CantSelectSamePkmn[] = _("Can't select same MOé.");
...
const u8 gText_PkmnForSwap[] = _("MOé FOR SWAP");
...
const u8 gText_SamePkmnInPartyAlready[] = _("Same MOé in party already.");
