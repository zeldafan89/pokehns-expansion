...
static const u8 *const sPageDescriptions[] =
{
    ...
    [POKENAV_MENUITEM_CONDITION]               = COMPOUND_STRING("Check MOéMON in detail."),
    ...
    [POKENAV_MENUITEM_SWITCH_OFF]              = COMPOUND_STRING("Put away the MOéGEAR."),
    [POKENAV_MENUITEM_CONDITION_CANCEL]        = COMPOUND_STRING("Return to the MOéGEAR menu."),
#else
    [POKENAV_MENUITEM_SWITCH_OFF]              = COMPOUND_STRING("Put away the MOéNAV."),
    [POKENAV_MENUITEM_CONDITION_CANCEL]        = COMPOUND_STRING("Return to the MOéNAV menu."),
#endif
    [POKENAV_MENUITEM_CONDITION_PARTY]         = COMPOUND_STRING("Check party MOéMON in detail."),
    [POKENAV_MENUITEM_CONDITION_SEARCH]        = COMPOUND_STRING("Check all MOéMON in detail."),
    [POKENAV_MENUITEM_CONDITION_SEARCH_COOL]   = COMPOUND_STRING("Find cool MOéMON."),
    [POKENAV_MENUITEM_CONDITION_SEARCH_BEAUTY] = COMPOUND_STRING("Find beautiful MOéMON."),
    [POKENAV_MENUITEM_CONDITION_SEARCH_CUTE]   = COMPOUND_STRING("Find cute MOéMON."),
    [POKENAV_MENUITEM_CONDITION_SEARCH_SMART]  = COMPOUND_STRING("Find smart MOéMON."),
    [POKENAV_MENUITEM_CONDITION_SEARCH_TOUGH]  = COMPOUND_STRING("Find tough MOéMON."),
