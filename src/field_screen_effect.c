...
static const u8 sText_PlayerScurriedToCenter[] = _("{PLAYER} scurried to a MOéMON CENTER,\nprotecting the exhausted and fainted\nMOéMON from further harm…\p");
static const u8 sText_PlayerScurriedBackHome[] = _("{PLAYER} scurried back home, protecting\nthe exhausted and fainted MOéMON from\nfurther harm…\p");
static const u8 sText_PlayerRegroupCenter[] = _("{PLAYER} scurried to a MOéMON CENTER,\nto regroup and reconsider the battle\nstrategy…\p");
